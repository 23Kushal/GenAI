...
# Input box
user_input = st.text_input("Ask something:", key="_gemini_input", value=st.session_state.user_input)

# Store input in session state without triggering actions
    ...
    if user_input.strip():
        with st.spinner("Thinking..."):
            try:
                ...
                st.session_state.history.append((user_input, safe_response))
